...
//   - changed  physical vertical spacing 19cm for 0.83λ of Frey's 1.31 GHz
//   - changed horizontal spacing to 32.7cm proportionally from above
//   - Need to plumb in: replace the /dev/csi_stream0 ring buffer reads with reads from 4× synchronized SDRs (HackRF or otherwise)
...
#define ANT_DIST_VERT    0.19f          // 0.190m for 0.83λ at 1.31 GHz (aiming Frey's frequency)
